...
const Footer = () => {
    return (
        <section className='bg-[#fafafa] px-10'>
            <div className='grid grid-cols-5 gap-2 py-8 px-28'>
                <div className='flex flex-col justify-center items-center gap-2'>
                    <div className="text-4xl text-zinc-700">
                        <LiaShippingFastSolid />
                    </div>
                    <h4 className='text-xl text-zinc-700 font-medium'>Free Shipping</h4>
                ...
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <h4 className='text-xl text-zinc-700 font-medium'>30 Days Returns</h4>
                ...
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <h4 className='text-xl text-zinc-700 font-medium'>Secured Payment</h4>
                ...
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <h4 className='text-xl text-zinc-700 font-medium'>Special Gifts</h4>
                ...
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <h4 className='text-xl text-zinc-700 font-medium'>Support 24/7</h4>
                    <p className='text-sm'>Contact us anytime</p>
                </div>
            </div>

            <hr className="h-0 text-zinc-200 " />
            <div className="footer py-8 flex">
                <div className="col1 w-[25%] border-r border-zinc-200 flex flex-col">
                    ...
                    <span className="text-xl font-semibold text-primary">(+91) 123 332 1221</span>
                    <div className="py-4 flex items-center">
                        <span className="text-primary text-4xl">
                            <IoChatboxOutline />
                        </span>
                        <div>
                            <p className="font-semibold leading-4">Online Chat</p>
                            <p className="font-semibold leading-4">Get Expert Help</p>
                        </div>
                    </div>
                </div>
                <div className="col2 w-[40%] flex ps-8">
                    <div className="w-[50%]">
                ...
                <div className="col3 w-[35%] flex flex-col px-8">
